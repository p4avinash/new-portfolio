  ...
  return (
    <section className='bg-slate-950 py-20 text-slate-100 border-b border-slate-900 overflow-hidden' id='about'>
      <div className='align-element'>
        <SectionTitle text='About & Background' subtitle='Senior Engineering Narrative' />
        ...
        <div className='grid lg:grid-cols-12 items-center gap-12 mt-8'>
          ...
          >
            <div className='relative w-full max-w-sm p-4 bg-slate-900/60 border border-slate-800 rounded-3xl backdrop-blur-md shadow-2xl animate-float-slow hover:border-violet-500/30 transition-colors duration-300'>
              <div className='absolute -inset-1 rounded-3xl bg-gradient-to-r from-violet-500/10 to-indigo-500/10 blur-lg -z-10 animate-glow-pulse'></div>
            ...
            <div className='w-full max-w-sm space-y-3'>
              {certifications.map((cert, index) => (
                ...
                >
                  <div className='w-9 h-9 rounded-lg bg-violet-500/10 border border-violet-500/30 flex items-center justify-center text-violet-400 shrink-0 shadow-sm'>
          ...
          >
            <div className='glass-panel bg-gradient-to-b from-slate-900/80 via-slate-900/40 to-slate-950/90 p-6 sm:p-8 rounded-2xl space-y-4 shadow-xl border border-slate-800/80 hover:border-t-violet-500/60'>
              <h3 className='text-2xl font-bold text-slate-100 tracking-tight'>
                Engineering scalable web products & AI systems with precision
              </h3>
              ...
              <p className='text-slate-300 leading-relaxed text-sm sm:text-base'>
                Beyond core frontend engineering, I build production <span className='text-violet-400 font-semibold'>Retrieval-Augmented Generation (RAG)</span> applications powered by Pinecone vector databases, Groq LLMs, and semantic search workflows.
              </p>
            ...
            <motion.div
              ...
              className='glass-panel bg-slate-900/60 p-6 rounded-2xl flex items-start gap-4 transition-colors shadow-lg border border-slate-800'
            >
              <div className='w-12 h-12 rounded-xl bg-violet-500/10 border border-violet-500/30 flex items-center justify-center text-violet-400 shrink-0 mt-1 shadow-sm'>
